...
const SearchExcercises = ({bodyPart,setBodyPart}) => {
  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      ...
      sx={{ fontSize: { lg: '44px', xs: '30px' } }} mb="49px" 
      textAlign="center">
      ...
      <Box position='relative' mb='72px'>
        ...
        border: 'none', borderRadius: '4px' }, width: { lg: '1170px', xs: '350px' }, backgroundColor: '#fff', borderRadius: '40px' }}
      ...
      <Box sx={{position:'relative',width:{lg:"100%",xs:"100%"},p:"20px"}}>
